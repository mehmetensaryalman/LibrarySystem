...
namespace LibrarySystem.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260828112646_AddTelegramBorrowReminderTracking")]
    partial class AddTelegramBorrowReminderTracking
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LibrarySystem.Domain.Entities.BorrowRecord", b =>
                {
                    ...
                    b.Property<DateTime?>("ThreeDaysReminderSentAt")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("LibrarySystem.Domain.Entities.TelegramConnection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("ConnectionCodeExpiresAt")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("ChatId")
                        .IsUnique()
                        .HasDatabaseName("UX_TelegramConnections_ChatId")
                        .HasFilter("[ChatId] IS NOT NULL");

                    b.HasIndex("ConnectionCodeHash")
                        .IsUnique()
                        .HasDatabaseName("UX_TelegramConnections_ConnectionCodeHash")
                        .HasFilter("[ConnectionCodeHash] IS NOT NULL");

                    b.HasIndex("UserId")
                        .IsUnique()
                        .HasDatabaseName("UX_TelegramConnections_UserId");

                    b.ToTable("TelegramConnections", (string)null);
                });
